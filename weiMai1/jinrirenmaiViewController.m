...
@interface jinrirenmaiViewController ()<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate>
{
    //数据源
...
@implementation jinrirenmaiViewController
...
-(void)requestDatafromURLstr:(NSString *)urlString{
    ...
    NSDictionary *dic=@{@"type":@"0",@"pageNumber":[NSString stringWithFormat:@"%d",_page],@"pageSize":@"10",@"keyword":_sousuoTextfield.text};
...
//    [[UIApplication sharedApplication]openURL:[NSURL URLWithString:@"sms://466453"]];
    ...
    if (_dataMutableArr.count>0) {
        ...
        NSLog(@"号码%@",[_dataMutableArr objectAtIndex:btn.tag]);
