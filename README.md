...
原	CocoaPods安装和使用及问题：Setting up CocoaPods master repo
发表于1年前(2014-03-07 17:31)   阅读（6840） | 评论（0） 13人收藏此文章, 我要收藏
赞6
7月18日 杭州 OSC 源创会 —— 开源的 Swift 2.0

摘要 ios依赖管理三种方式：手动、git submodule、cocoapods，CocoaPods是一个Objective-C第三方库的管理利器。


目录[-]
目录CocoaPods是什么？如何下载和安装CocoaPods？如何使用CocoaPods？场景1：利用CocoaPods，在项目中导入AFNetworking类库场景2：如何正确编译运行一个包含CocoPods类库的项目
目录
...
分享到： 6赞
原文地址：https://www.google.com.hk/url?sa=t&rct=j&q=&esrc=s&source=web&cd=1&ved=0CCgQFjAA&url=%68%74%74%70...
* « 上一篇* 下一篇 »
